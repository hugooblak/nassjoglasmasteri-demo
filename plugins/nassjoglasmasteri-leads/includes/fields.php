...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'nassjoglasmasteri-leads' ),
				'storm'       => __( 'Storm or hail damage', 'nassjoglasmasteri-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'nassjoglasmasteri-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'nassjoglasmasteri-leads' ),
				'not-sure'    => __( 'Vet inte än', 'nassjoglasmasteri-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'nassjoglasmasteri-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'nassjoglasmasteri-leads' ),
				'research' => __( 'Jag kollar bara priser', 'nassjoglasmasteri-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'nassjoglasmasteri-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'nassjoglasmasteri-leads' ),
		'contacted' => __( 'Kontaktad', 'nassjoglasmasteri-leads' ),
		'quoted'    => __( 'Quote sent', 'nassjoglasmasteri-leads' ),
		'won'       => __( 'Won', 'nassjoglasmasteri-leads' ),
		'lost'      => __( 'Lost', 'nassjoglasmasteri-leads' ),
		'spam'      => __( 'Misstänkt spam', 'nassjoglasmasteri-leads' ),
	);
}
